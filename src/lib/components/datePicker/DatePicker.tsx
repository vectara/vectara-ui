...
export const VuiDatePicker = ({
  ...
  const { isOpen, setIsOpen, anchorSide, header } = rest as InPopoverProps;
  ...
  return (
    <VuiPopover isOpen={isOpen} setIsOpen={setIsOpen} button={input} anchorSide={anchorSide} header={header}>
      {datePicker}
    </VuiPopover>
  );
};
